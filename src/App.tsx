        ...
        <div className="flex items-center justify-center p-8">
          ...
          >
            <div className="text-center">
              ...
              <p className="mt-2 text-slate-400">Identify yourself to continue</p>
            </div>
            ...
            <form className="mt-8 space-y-6" onSubmit={handleLogin}>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Endpoint Identity</label>
                  <input
                    type="email"
                    required
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                    className="w-full px-4 py-4 rounded-xl border border-white/10 bg-white/5 focus:ring-2 focus:ring-blue-500 transition-all outline-none text-white font-mono text-sm"
                    placeholder="email@access.net"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Security Hash</label>
                  <input
                    type="password"
                    required
                    value={password}
              ...
              <Button className="w-full py-4 text-sm" loading={loading}>
                Execute Login
              </Button>
            </form>
          </motion.div>
